...
<script>
	...
	function formValidCheck()(){
		...
		var id = document.f.memberId;
		if ( id == '') {
			alert("아이디를 입력하세요.");
			document.f.memberId.onfocus = true;
			return false;
		}
...
<body>
	<form name="f" action="${contextPath}/member/addMember.do" method="post" onsubmit="return formValidCheck()">
	<h3>회원가입</h3>
